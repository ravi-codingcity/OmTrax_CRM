...
const ResetPassword = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setApiError(err.response?.data?.message || 'Password reset failed. Please check your credentials and try again.');
    }
    setIsLoading(false);
  };

  const inputClasses = (field) => `w-full px-3 py-2.5 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all text-sm ${
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 flex items-center justify-center p-4">
      <div className="w-full max-w-sm">
        ...
        <div className="bg-white rounded-xl shadow-lg shadow-gray-200/50 p-6 border border-red-500">
          ...
          <h2 className="text-xl font-semibold text-red-500 text-center mb-2">Reset Password</h2>
          <p className="text-gray-500 text-sm text-center mb-4">Enter your credentials to reset your password</p>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  onChange={handleChange}
                  className={`${inputClasses('oldPassword')} pr-10`}
              ...
              {errors.oldPassword && <p className="text-red-500 text-xs mt-0.5">{errors.oldPassword}</p>}
            </div>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  onChange={handleChange}
                  className={`${inputClasses('newPassword')} pr-10`}
              ...
              {errors.newPassword && <p className="text-red-500 text-xs mt-0.5">{errors.newPassword}</p>}
            </div>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  onChange={handleChange}
                  className={`${inputClasses('confirmNewPassword')} pr-10`}
              ...
              {errors.confirmNewPassword && <p className="text-red-500 text-xs mt-0.5">{errors.confirmNewPassword}</p>}
            </div>
