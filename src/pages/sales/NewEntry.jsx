  ...
  return (
    <MainLayout>
      <div className="max-w-4xl mx-auto">
        {/* Page Header */}
        <div className="mb-4">
          <h1 className="text-xl font-bold text-gray-800">New Sales Entry</h1>
          <p className="text-gray-500 text-xs mt-0.5">Add a new sales lead to the system</p>
        </div>
            ...
            <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg px-3 py-2 mb-4 border border-blue-100">
              <div className="flex flex-wrap items-center gap-x-6 gap-y-1 text-xs">
                <div>
                  ...
                  <span className="ml-1.5 font-medium text-gray-800">{user.name}</span>
                </div>
                <div>
                  <span className="text-gray-500">Branch:</span>
                  <span className="ml-1.5 font-medium text-gray-800">{user.branch}</span>
                </div>
                <div>
